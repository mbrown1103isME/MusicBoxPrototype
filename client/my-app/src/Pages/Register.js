      ...
      if((checkPassword === password)){
        if(password===""){
          setError(
            ...
            setError(
              {
                status: "danger",
                errorType: "No input",
                message: "Please input second password!"
              }
            )
          }else{
            ...
            try{
              const userPost = await axios.post("http://localhost:4000/api/auth/register",newUser)
      ...
      <MDBRow>
        ...
        <MDBCol sm='6'>
          ...
          <div className='d-flex flex-column justify-content-center h-custom-2 w-75 pt-4'>
            <h3 className="fw-normal mb-3 ps-5 pb-3" style={{letterSpacing: '1px'}}>Register Now</h3>

            <MDBInput wrapperClass='mb-4 mx-5 w-100' label='Email address' id='formControlLg' type='email' size="lg" onChange={handleEmail}/>
            <MDBInput wrapperClass='mb-4 mx-5 w-100' label='Username' id='formControlLg' type='username' size="lg" onChange={handleUser}/>
            <MDBInput wrapperClass='mb-4 mx-5 w-100' label='Create Password' id='formControlLg' type='password' size="lg" onChange={handlePassword}/>
            <MDBInput wrapperClass='mb-4 mx-5 w-100' label='Confirm Password' id='formControlLg' type='password' size="lg" onChange={handleCheckPassword}/>
            {/* <MDBBtn className="mb-4 px-5 mx-5 w-100" color='info' size='lg' onClick={setShow}>Register</MDBBtn> */}
            <Button className="mb-4 px-5 mx-5 w-100" color='info' size='md' onClick={handleShow}>Register</Button>
            <DisplayAlert status={error.status} type={error.errorType} mes = {error.message} id="errorBlob"/>
          </div>
...
Office: 165 11th St, San Francisco, CA 94103</Modal.Body>
        <Modal.Footer>
          ...
          <Button variant="primary" onClick={()=>{
            ...
            Accept Private Policy and Register 
          </Button>
        </Modal.Footer>
      </Modal>
    </MDBContainer>
